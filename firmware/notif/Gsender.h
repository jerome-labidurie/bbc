...
*  September 29 2016
*
* Source: http://www.instructables.com/id/ESP8266-GMail-Sender/?ALLSTEPS
*
* usage:
* #include "Gsender.h"
*
...
class Gsender
{
    ...
    private:
        ...
        const char* EMAILBASE64_LOGIN = CRED_EMAILBASE64_LOGIN;
        const char* EMAILBASE64_PASSWORD = CRED_EMAILBASE64_PASSWORD;
        const char* FROM = CRED_FROM;
